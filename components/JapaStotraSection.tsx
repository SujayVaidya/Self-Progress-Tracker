    ...
    <View>
      ...
      <View style={styles.activityRow}>
        <View style={[styles.activityImage, { backgroundColor: '#3A2E1F' }]}>
          <Text style={{ fontSize: 24, textAlign: 'center', lineHeight: 50, color: '#FFD700' }}>
            ॐ
          </Text>
        </View>
        <View style={styles.activityContent}>
          <Text style={styles.activityText}>Mantra Japa (Goal: 3)</Text>
      ...
      <View style={styles.activityRow}>
        ...
        <View style={styles.activityContent}>
          <Text style={styles.activityText}>Stotra Recitations (Goal: 3)</Text>
          <View style={styles.checkboxContainer}>
            {[0, 1, 2].map((index) => (
              <Checkbox
                key={index}
